...
public class MessageDao_Impl(
  ...
  public override suspend fun getAllMessages(): List<Message> {
  ...
  public override suspend fun getMessagesForConversationIds(conversationIds: List<Long>): List<Message> {
    val _stringBuilder: StringBuilder = StringBuilder()
    _stringBuilder.append("SELECT * FROM messages WHERE conversationId IN (")
    ...
    return performSuspending(__db, true, false) { _connection ->
      ...
      try {
        ...
        while (_stmt.step()) {
          ...
          val _tmpTimestamp: Long
          _tmpTimestamp = _stmt.getLong(_columnIndexOfTimestamp)
          _item_1 = Message(_tmpId,_tmpConversationId,_tmpText,_tmpIsUser,_tmpIsHtml,_tmpTimestamp)
          _result.add(_item_1)
        }
        _result
      } finally {
